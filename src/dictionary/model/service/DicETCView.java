...
public class DicETCView implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		int listcount = dicdao.getListCount("word_etc");	//총 리스트 수를 받아옴.
		System.out.println("총 리스트 수 = " + listcount);
		
		dicdatalist = dicdao.getdicList(page,limit,"word_etc");	//리스트를 받아
