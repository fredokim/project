...
public class DicSQLView implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		int listcount = dicdao.getListCount("word_sql");	//총 리스트 수를 받아옴.
		System.out.println("총 리스트 수 = " + listcount);
		
		dicdatalist = dicdao.getdicList(page,limit,"word_sql");	//리스트를 받아
