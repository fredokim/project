...
<%@page import="community.model.vo.CommentBean"%>
<%
 ...
 %>
			...
			<tr class="center">
				<td colspan="2" class="lime"><a id="reply"
					href="./BoardReplyView2.bo?num2=<%=board.getBoard_num()%>"> <span
						class="span"> 답변 </span>
				</a>&nbsp;&nbsp; <a id="modify"
					href="./BoardModify2.bo?num2=<%=board.getBoard_num()%>"> <span
						class="span"> 수정</span>
				</a>&nbsp;&nbsp; <a id="delete"
					href="./BoardDeleteAction2.bo?num2=<%=board.getBoard_num()%>">
						<span class="span">삭제</span>
				</a>&nbsp;&nbsp; <a id="boardlist" href="./BoardList2.bo"> <span
						class="span">목록</span>
				</a>&nbsp;&nbsp;</td>
			</tr>
		</table>
		<form action="./CommentWrite.bo" method="post" name="commentform">
			<table id="comment" class="table" >
				...
				<tr>
					...
					<td>
						<a  href="./CommentDelete.bo?comment_num=<%=cl.getComment_num()%>">
							<span class="span">삭제</span>
					</a></td>
				</tr>
				<%
				...
				<tr>
					<td><input type="hidden" name="comment_id"
						...
						name="comment_board" value="<%=board.getBoard_num()%>">
						<div id="comment_sub">
						댓글달기
						</div>
						</td>
