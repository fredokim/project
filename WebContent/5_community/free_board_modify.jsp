...
<body>
	...
	<form action="BoardModifyAction.bo" method="post" name="modifyform">
		<input type="hidden" name="board_num2"
			...
			name="board_id2" value="<%=session.getAttribute("id")%>">

		<div class="animate-box">
			<article id="main">
				<h3 id="title">자유 게시판 - 글 수정</h3>
				<table id="list">
					<tr>
						<td width="10%" id="subjecthead">
							<div id="subject">제 목</div>
						</td>
						<td><input id="subjectset" name="board_subject2" size="103"
							maxlength="150" value="<%=board.getBoard_subject()%>"></td>
					</tr>
					<tr>
						<td id="contenthead">
							<div id="content" align="center">내 용</div>
						</td>
						<td><textarea id="contentset" name="board_content2"
								cols="100" rows="15"><%=board.getBoard_content()%></textarea></td>
					</tr>
					<%
					...
					<tr>
						<td colspan="2" class="center"><a id="modify"
							href="javascript:modifyboard()"><span class="span">수정</span>
