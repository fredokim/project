...
<body>
				...
				<tr>
					...
					<td>
						<div id="div">
							...
							%>
							<a id="view"
								href="./BoardDetailAction2.bo?num2=<%=bl.getBoard_num()%>">
								<%=bl.getBoard_subject()%>
							</a>
						</div>
					</td>
 ...
 %> <a id="beforepage" href="./BoardList2.bo?page=<%=nowpage - 1%>">
							<span class="span"> 이전 </span>
					</a> <%
 	}
 %> <%
 ...
 %> <a href="./BoardList2.bo?page=<%=a%>"><%=a%> </a> &nbsp; <%
 	}
 %> <%
 	}
 %> <%
 ...
 %> <a id="nextpage" href="./BoardList2.bo?page=<%=nowpage + 1%>"> <span
							class="span"> 다음 </span>
					</a> <%
 	}
 %>
				...
				<tr align="right" class="center">
					<td colspan="5" id="center">
						...
						%> <a id="admin" href="./MemberListAction.me"><span
							class="span">회원관리</span></a> <%
 	}
 %> <a id="write" href="./BoardWrite2.bo"> <span class="span">
								글쓰기 </span>
					</a>
					</td>
				</tr>
			...
			<form action="./SearchBoard.bo" id="list-form">
