<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="admin.model.vo.MemberBean"%>
...
<html>
<head>
<title>IT WORLD - [관리자] 회원 정보 조회</title>
...
<body class="bg-dark">
	<div class="container">
		<div class="card card-login mx-auto mt-5">
			...
			<div class="card-body">
				<form action="./MemberModifyView.ad" method="post">
					...
					<div class="form-group">
						<label for="exampleInputPassword1">비밀번호</label> <input
							...
							value="<%=member.getMember_pw()%>" readonly>
					</div>
					...
					<input class="btn btn-primary btn-block" type=button value="회원정보수정"
						...
						class="btn btn-primary btn-block" type="button" value="닫기"
						onclick="self.close()">
