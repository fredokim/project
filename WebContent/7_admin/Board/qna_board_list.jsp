...
<html>
<head>
<title>IT WORLD - [게시판관리] 문의 게시판 리스트</title>
...
<body>
			...
			<tr>
				...
				<td>
					<div id="div">
						...
						%>
						<a id="view"
							href="./BoardDetailAction.ad?num=<%=bl.getBoard_num()%>"> <%=bl.getBoard_subject()%>
						</a>
					</div>
				</td>
 ...
 %> <a id="beforepage" href="./BoardList.ad?page=<%=nowpage - 1%>"><span
 ...
 %> <a href="./BoardList.ad?page=<%=a%>"><span class="span">
							<%=a%></span> </a> &nbsp; <%
 	}
 %> <%
 	}
 ...
 %> <a id="nextpage" href="./BoardList.ad?page=<%=nowpage + 1%>">[다음]</a>
					<%
						}
					%>
				</td>
			...
			<tr align="right">
				<td colspan="5"><a id="write" href="./BoardWrite.ad"><span
						class="span">글쓰기</span></a></td>
			</tr>
		</table>
	</article>
</body>
