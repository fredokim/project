...
<head>
	...
	<title>ITWORLD - [ 오답노트 SQL-D ]</title>
...
<body>
	...
	<div id="dictionary">
		<span class="animate-box"><a href="WrongNoteView.no"
			class="dictionary_name">정보처리기사</a></span> <span class="animate-box"><a
			class="dictionary_name now_page"> SQL-D</a></span> <span class="animate-box"><a
			href="WrongNoteViewLinux.no" class="dictionary_name"> 리눅스 마스터</a></span> <span
			class="animate-box"><a href="WrongNoteViewETC.no"
	...
	%>	
		...
		<% if(mylist.size() == 0){	%>
			<div class="animate-box dictionary_name" style="width:50% ; margin:130px 380px;" > 등록된 오답노트가 없습니다.</div>
		<% } else{
